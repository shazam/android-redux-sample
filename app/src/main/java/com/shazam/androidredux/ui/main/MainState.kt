...
data class MainState(val chart: Chart?, val error: Throwable?, val isLoading: Boolean) : State

val emptyMainState = MainState(chart = null, error = null, isLoading = false)
